...
/*DeleteStudent swagger:route DELETE /student student deleteStudent
...
// DeleteStudentBody delete student body
//
// swagger:model DeleteStudentBody
type DeleteStudentBody struct {

	// id
	ID int64 `json:"id,omitempty"`
}

// Validate validates this delete student body
func (o *DeleteStudentBody) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *DeleteStudentBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *DeleteStudentBody) UnmarshalBinary(b []byte) error {
	var res DeleteStudentBody
